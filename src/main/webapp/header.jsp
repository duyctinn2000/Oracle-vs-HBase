...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
        ...
        <div class="logo mr-auto">
            <h1><a href="${pageContext.request.contextPath}/main">HỆ QUẢN TRỊ CƠ SỞ DỮ LIỆU</a></h1>
...
<c:choose>
    <c:when test="${param.home==1}">
        <section id="hero" class="d-flex flex-column justify-content-center align-items-center" style = " height: 35vh;">
    ...
    <c:otherwise>
        ...
        <main id="main" class="border-top" style=" padding-top: 70px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/main">Home</a>
                    </li>
