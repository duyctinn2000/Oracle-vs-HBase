            ...
            <div class="col-lg-12">
                <div class="featured__controls">
                    <ul>
                        ...
                        <li class="active" data-filter=".general">Tải File Chứa Danh Sách Từ Vào Database</li>
            ...
            <div class="profile__featured__general  col-lg-12 mix general">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-5 profile__name">
                        <form action="loadfile" id="signup_form" method="post" enctype="multipart/form-data">
                            <!-- form field-->
